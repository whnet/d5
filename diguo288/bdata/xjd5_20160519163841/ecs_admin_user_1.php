...
E_D("replace into `ecs_admin_user` values('1','admin','admin@68ecshop.com','2b42a5d5098e22b04a67de29c3ab4aaa','2897','1416555690','1463646989','139.205.55.228','all','商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit','','0','0','','0');");
