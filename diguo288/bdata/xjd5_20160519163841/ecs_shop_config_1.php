...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','小京东5.0单仓库 商家入驻 微信支付 附近商店 预售 拍卖','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','小京东5.0单仓库 商家入驻 微信支付 附近商店 预售 拍卖','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','小京东5.0单仓库 商家入驻 微信支付 附近商店 预售 拍卖','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','网上购物,网上商城,手机,笔记本,电脑,MP3,CD,VCD,DV,相机,数码,配件,手表,存储卡,京东','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','青羊区','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','39035000','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','zhenlinlin1983','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','39035000@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('241','2','certi','hidden','','','http://service.xxxx.cn/openapi/api.php','1');");
...
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','39035000@qq.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','isnzgwgetwjtbhge','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','39035000@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('605','6','install_date','hidden','','','1314153667','1');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:3:\"50%\";s:15:\"level_money_all\";s:3:\"50%\";s:18:\"level_register_all\";i:2;s:17:\"level_register_up\";i:60;}s:4:\"item\";a:4:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"30%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}i:3;a:2:{s:11:\"level_point\";s:2:\"3%\";s:11:\"level_money\";s:2:\"3%\";}}s:2:\"on\";i:1;}','1');");
...
E_D("replace into `ecs_shop_config` values('1031','8','sms_order_shipped','select','1,0','','1','9');");
E_D("replace into `ecs_shop_config` values('1030','8','sms_order_payed','select','1,0','','1','5');");
E_D("replace into `ecs_shop_config` values('1029','8','sms_order_placed','select','1,0','','1','3');");
...
E_D("replace into `ecs_shop_config` values('150','1','erweima_wapurl','text','','','http://www.0838g.com/goods.php?id={id}','1');");
...
E_D("replace into `ecs_shop_config` values('1028','8','sms_shop_mobile','text','','','15652190983','1');");
...
E_D("replace into `ecs_shop_config` values('1033','8','sms_goods_stockout','select','1,0','','1','13');");
...
E_D("replace into `ecs_shop_config` values('1036','8','sms_sign','text','','','小鲸懂经典版','2');");
E_D("replace into `ecs_shop_config` values('1037','8','sms_goods_stockout_tpl','textarea','','','您登记的商品%s已经到货，您可点击下面链接直接进入商品页面浏览或购买！%s【%s】','14');");
E_D("replace into `ecs_shop_config` values('1038','8','sms_order_pay','select','1,0','','1','7');");
...
E_D("replace into `ecs_shop_config` values('1041','8','sms_pricecut','select','1,0','','1','11');");
...
E_D("replace into `ecs_shop_config` values('1052','8','ecsdxt_user_name','text','','','2105111304','0');");
E_D("replace into `ecs_shop_config` values('1053','8','ecsdxt_pass_word','password','','','3ed0b3','0');");
E_D("replace into `ecs_shop_config` values('12','0','app','hidden','','','APP设置','1');");
E_D("replace into `ecs_shop_config` values('1054','12','push_setting','manual','','','a:1:{i:0;a:3:{s:8:\"app_name\";s:26:\"商之翼小京东V4开发\";s:7:\"app_key\";s:0:\"\";s:10:\"app_secret\";s:0:\"\";}}','1');");
