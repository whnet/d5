...
E_D("replace into `ecs_keyword` values('2','ecshop','女','女','nv','23','1453271859','5','2','2','2','1','手机、数码、通信','search.php?category=4&keywords=iphone','3');");
E_D("replace into `ecs_keyword` values('3','ecshop','冰箱','冰箱','bingxiang','2','1438048806','15','15','15','15','1','食品、酒类、生鲜、特产','search.php?category=1&keywords=好丽友','1');");
...
E_D("replace into `ecs_keyword` values('25','ecshop','格力电暖器','格力电暖器','gelidiannuanqi','2','1463618785','3','1','1','1','1','','','0');");
