...
.article_menu LI.button A {
	/*BACKGROUND: url(images/menu_bottom.gif) #222d32 no-repeat center 44px;*/
	background:#222d32;
	DISPLAY: block;
	FONT-SIZE: 14px;
	OVERFLOW: hidden;
...
.dropdown LI {
	DISPLAY: block;
	PADDING-LEFT: 55px;
	BACKGROUND: url(images/menu_arrow.png) no-repeat 0px center;
	COLOR: #666;
	LINE-HEIGHT: 30px;
	/*BORDER-BOTTOM: #f2f2f2 1px solid;*/
	HEIGHT: 30px;
}
.dropdown LI a{color:#8aa4af;text-decoration:none}
