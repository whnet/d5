...
<form action="affiliate_ck.php?act=list">
  ...
  <a class="stats_a" href="affiliate_ck.php?act=list"><?php echo $this->_var['lang']['sch_stats']['all']; ?></a>
  <a class="stats_a" href="affiliate_ck.php?act=list&status=0"><?php echo $this->_var['lang']['sch_stats']['0']; ?></a>
  <a class="stats_a" href="affiliate_ck.php?act=list&status=1"><?php echo $this->_var['lang']['sch_stats']['1']; ?></a>
  <a class="stats_a" href="affiliate_ck.php?act=list&status=2"><?php echo $this->_var['lang']['sch_stats']['2']; ?></a>
...
<tr>
  <th width="16%"><?php echo $this->_var['lang']['order_id']; ?></th>
  ...
  <th width="14%"><?php echo $this->_var['lang']['separate_type']; ?></th>
