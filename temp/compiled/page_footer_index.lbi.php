...
?>
          <dl class="col-article <?php if (($this->_foreach['no']['iteration'] <= 1)): ?>col-article-first<?php endif; ?>">
            ...
            <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_83965600_1466048971');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_83965600_1466048971']):
?>
            <dd><a rel="nofollow" href="help.php?id=<?php echo $this->_var['item_0_83965600_1466048971']['article_id']; ?>" target="_blank"><?php echo $this->_var['item_0_83965600_1466048971']['short_title']; ?></a></dd>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </dl>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <dl class="col-article">
                <dt>服务支持</dt>
                <dd>售前咨询 010-57125663</dd>
                <dd>客服 QQ 872562548</dd>
...
?>
        ...
        <p class="nav_bottom">
            ...
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_83965600_1466048971');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_83965600_1466048971']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
            <a href="<?php echo $this->_var['nav_0_83965600_1466048971']['url']; ?>"  <?php if ($this->_var['nav_0_83965600_1466048971']['opennew'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $this->_var['nav_0_83965600_1466048971']['name']; ?></a><em <?php if (($this->_foreach['nav_bottom_list']['iteration'] == $this->_foreach['nav_bottom_list']['total'])): ?>style="display:none"<?php endif; ?>>|</em>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php endif; ?>
